...
#define LED_GREEN_ON()			palSetPad(GPIOF, 9)
#define LED_GREEN_OFF()			palClearPad(GPIOF, 9)
#define LED_RED_ON()			palSetPad(GPIOF, 10)
#define LED_RED_OFF()			palClearPad(GPIOF, 10)
